...
* [Download the most recent pdf version](https://github.com/ChandlerLutz/differences-in-differences-in-differences-CFPLs/blob/master/CFPLs_DDD.pdf).

# Overview

This case study will use a difference-in-differences-in-differences
...
#Read in the Data
DT <- readRDS("data-raw/county_forc_cfpl_data.rds")
```
